...
export default function Contact({ data }) {
  return (
    <Layout>
      <SEO
        title="Contact Chris"
        keywords={['chris gibbons', 'contact chris gibbons', 'accessibility']}
      />
      ...
      <section className="c-content">
        ...
        <div className="c-content__body">
          ...
          <p>
            ...
            something longer, then please email me - though don’t be offended if
            it takes a day or so to reply!
          </p>
          <ul>
            <li>
              <a href="https://www.twitter.com/_gbbns">Twitter - @_gbbns</a>
            </li>
            <li>
              <a href="mailto:chris@gbbns.co">Email - chris@gbbns.co</a>
            </li>
          </ul>
        </div>
      </section>
