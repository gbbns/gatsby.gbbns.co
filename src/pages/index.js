    ...
    <Layout>
      ...
      <section className="c-content">
        ...
        <div className="c-content__body">
          <p>
            An experienced frontend developer based in Lancashire [53.7632° N,
            2.7044° W], UK.
          </p>
          <p>
            I build fast, user friendly and accessible websites for the
            automotive industry, with a particular passion/obsession for well
            written and clean code.
          </p>
          <p>
            I’ve got over a decades experience as a front end developer and have
            recently found a passion for UX and accessibility. My career has
            been spent working for some of the top businesses—both agency and
            in-house—in Manchester. During this time I have been fortunate to
            have the chance to work on large scale, content-managed platforms
