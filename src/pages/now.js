...
export default function Now({ data }) {
  return (
    <Layout>
      <SEO
        title="So what is Chris Gibbons doing now?"
        keywords={[
          'gatsby',
          'now page',
      ...
      <section className="c-content">
        ...
        <div className="c-content__body">
          <p>
            Life is a hectic affair; To help keep me sane and to give me some
            guidance, these are my current areas of focus:
          </p>
          ...
          <ul>
            <li>
              Continuing to promote and improve both of the guilds I&lsqo;ve
              setup &ndash; the <abbr title="Inclusive Design Guild">IDG</abbr>{' '}
              &amp; the <abbr title="Front End">FE</abbr> guild
            </li>
            <li>
              Devoting time out to meetup regularly with my mentor(s) for a
              coffee
            </li>
            <li>
