  ...
  return (
		<aside className="c-colophon">
			...
			<ul className="c-colophon__list">
				<li className="c-colophon__items">Built using: <a href="https://code.visualstudio.com/" rel="noopener">Visual Studio Code</a></li>
				<li className="c-colophon__items">Generated with: <a href="https://gatsbyjs.org" rel="noopener">Gatsby</a></li>
				<li className="c-colophon__items">Hosted on: <a href="https://github.com/gbbns/gatsby.gbbns.co" rel="noopener">Github</a></li>
				<li className="c-colophon__items">Published on: <a href="https://www.netlify.com/" rel="noopener">Netlify</a></li>
