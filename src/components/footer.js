	...
	return (
		<footer class="c-footer">
			<div className="card card--message">
				...
				<p>In the true sprit of Agile, I believe that coding in the open promotes sharing, enables better and faster feedback and provides a great opportunity for learning.</p>
			...
			<nav>
				<ul className="h-list">
					<li className="h-list__item">
						<Link to="/colophon"
									activeClassName="is-active">Colophon</Link>
					</li>
					<li className="h-list__item">
						<Link to="/now"
									activeClassName="is-active">Now</Link>
					</li>
					<li className="h-list__item">
						<Link to="/uses"
									activeClassName="is-active">Uses</Link>
					</li>
					<li className="h-list__item">
						<Link to="/tags"
									activeClassName="is-active">Tags</Link>
					</li>
				</ul>
			</nav>
